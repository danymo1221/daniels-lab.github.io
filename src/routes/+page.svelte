  ...
  <div class="w-full flex flex-col lg:flex-row gap-4 justify-center items-center lg:items-stretch">
    <Card.Root class="w-full max-w-sm shadow-md flex flex-col h-full bg-white/10 backdrop-blur-2xl border border-white/30 rounded-xl text-white">
      <Card.Header class="flex flex-col items-center justify-center space-y-4 text-center">
        ...
        <Card.Description class="text-neutral-300">24 year old, system integration specialist, coder, hobbyist</Card.Description>
        <Card.Description class="text-neutral-300">server integration, networking, gaming</Card.Description>
      </Card.Header>
          ...
          <Tooltip.Root>
            <Tooltip.Trigger>
              <Button
                variant="default"
                size="icon"
                href="https://github.com/danymo1221/"
                target="_blank"
          ...
          <Tooltip.Root>
            <Tooltip.Trigger>
              <Button
                variant="default"
                size="icon"
                href="mailto:me@daniels-lab.com"
                target="_blank"
                aria-label="Send email to me@daniels-lab.com"
              >
                <Mail />
              </Button>
            </Tooltip.Trigger>
          ...
          <Tooltip.Root>
            <Tooltip.Trigger>
              <Button
                variant="default"
                size="icon"
                href="https://www.linkedin.com/in/danielpearce01/"
                target="_blank"
      ...
      <Card.Content class="flex-1 flex flex-col gap-4 justify-between">
        <ScrollArea class="flex flex-col w-full max-h-56 p-1">
          ...
          >
            ...
            <a
            href="https://mail.daniels-lab.com"
            target="_blank"
            rel="noopener noreferrer"
            class="flex items-center gap-4 p-4 rounded-xl shadow cursor-pointer w-full transition-all border border-white/30 bg-white/10 backdrop-blur-xl hover:shadow-lg hover:bg-white/20"
